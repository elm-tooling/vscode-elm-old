...
export function definitionLocation(document: vscode.TextDocument, position: vscode.Position,
  workspaceSymbolProvider: ElmWorkspaceSymbolProvider): Thenable<SymbolInformation> {
...
export class ElmDefinitionProvider implements vscode.DefinitionProvider {
  ...
  public provideDefinition(document: vscode.TextDocument, position: vscode.Position,
    ...
    return definitionLocation(document, position, this.workspaceSymbolProvider).then(
      definitionInfo => {
